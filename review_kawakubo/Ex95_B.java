...
public class Ex95_B {
	...
	public static void main(String[] args) {
		/*
		 * 今回はコメントも豊富で説く手順が丁寧に書かれており
		 * いいプログラムだと思います。1つの説明を1つのメソッド
		 * としてストーリーとして表現する方法もありかなと思います。
		 * 
		 * しかし、残念！
		 * 1つだけバグがありました。
		 * 修正しておきました。57行目以降を参照してください。
		 *
		 * 出力例1でテストしようとして誤って
		 * すべてのドーナツの1個当たりの重量を90とすべきところ
		 * 1つだけ9と入力して発見したバグです。
		 * 4 360
		 * 90
		 * 9
